...
// Define the TypeScript type for the loader data using Prisma's CourseGetPayload
...
// Define the frontend type with serialized dates
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {courses.map((course) => (
              <div
                key={course.id}
                className="bg-white rounded-lg shadow-sm p-6 transform transition hover:-translate-y-1 hover:shadow-xl"
              >
                <div className="flex justify-between items-center mb-4">
                  <span
                    className={`px-3 py-1 text-xs font-semibold rounded-full text-white ${
                      course.isFree ? "bg-green-500" : "bg-blue-500"
                    }`}
                  >
            ...
            <div className="text-center">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M12 9v2m0 4h.01m-6.938 4h13.856C18.978 19.5 20 18.485 20 17.25V6.75C20 5.515 18.978 4.5 17.644 4.5H6.356C5.022 4.5 4 5.515 4 6.75v10.5C4 18.485 5.022 19.5 6.356 19.5z"
                />
              </svg>
